...
window.onload = function(){
    function changeEventSendLog(dom, key){
    ...
    changeEventSendLog($('lossy'), 'quality_low');
    changeEventSendLog($('lossless'), 'quality_hight');
    changeEventSendLog($('settingShortcut'), 'short_cut');
    changeEventSendLog($('area-capture-hot-key'), 'select');
