...
var page = {
  ...
  */
  showProgress: function(args){
    ...
    page.progress.tipTxt.innerText = page.progress.shituTXT + ' - ' +intRadio+"%";
  ...
  createProgress:function(){
    ...
    page.progress.shituTXT = chrome.i18n.getMessage('progress_tip');
  ...
  */
  ...
  updateBtnPosition : function(){
     var crop = document.getElementById('sc_drag_crop');
        ...
        if (page.endY < 26||page.startY<26) {
          dragSizeContainer.style.top = 0;
        } else {
          dragSizeContainer.style.top = '-26px';
        }
  },
